...
// ─── Tracking Stubs ──────────────────────────────────────────────────
// Wire these to your Meta Pixel / dataLayer as needed
const trackEvent = (eventName, data = {}) => {
  // Meta Pixel: fbq('trackCustom', eventName, data);
  // or for Lead: fbq('track', 'Lead', data);
  // dataLayer: window.dataLayer?.push({ event: eventName, ...data });
